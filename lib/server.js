...
const pubnub = new PubNub({
  publishKey : 'pub-c-ec397dfc-ed75-43e4-93d0-1ad9cd2b899b',
  subscribeKey : 'sub-c-ca1b57ba-f0d4-11e6-9148-02ee2ddab7fe'
});
...
server.route({
  ...
  path: '/api/sentiment',
  handler: function (req, reply) {
    console.log('Add new score', req.payload);
